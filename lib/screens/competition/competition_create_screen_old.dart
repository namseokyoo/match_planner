...
class _CompetitionCreateScreenState extends State<CompetitionCreateScreen> {
  ...
  void _openTournamentModal() async {
    ...
    if (result != null && result is List<List<Map<String, dynamic>>>) {
      setState(() {
        _tournamentResults.add(result);
      });
    }
  }
  ...
  void _deleteTournament(int index) {
    setState(() {
      _tournamentResults.removeAt(index);
    });
  }
      ...
      children: List.generate(_leagueResults.length, (index) {
        return Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: List.generate(_leagueResults[index].length, (subIndex) {
          ...
          child: Column(
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: List.generate(_tournamentResults[index].length,
                      (roundIndex) {
                    return Padding(
                        ...
                        children: [
                          ...
                          Column(
                            children: List.generate(
                                _tournamentResults[index][roundIndex].length,
                                (matchIndex) {
                              final match = _tournamentResults[index]
